...
public class App : EmbeddingApplication
{
    ...
    {
        //#if WINDOWS
        //        MainWindow.As<IWindowNative>();
        //#endif

        var builder = this.CreateBuilder(args)
            // Add navigation support for toolkit controls such as TabBar and NavigationView
            .UseToolkitNavigation()
            .UseMauiEmbedding<MauiControls.EmbeddingApp>(maui => maui.UseMauiControls())
            .Configure(host => host
#if DEBUG
            ...
            new RouteMap("", View: views.FindByViewModel<ShellViewModel>(),
                Nested: new RouteMap[]
                {
                    new RouteMap("Main", View: views.FindByViewModel<MainViewModel>(), Nested: new RouteMap[]
                    {
                        ...
                        new RouteMap("AreaChart", View: views.FindByViewModel<AreaChartControlViewModel>()),
